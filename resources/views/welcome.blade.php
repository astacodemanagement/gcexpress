...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/png" href="{{ asset('themplete/back') }}/dist/images/logos/favicon.ico" />
        ...
        <aside class="left-sidebar with-vertical">
            <div><!-- ---------------------------------- -->
                ...
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="{{ asset('themplete/back') }}/../main/index.html" class="text-nowrap logo-img">
                    ...
                    <a href="{{ asset('themplete/back') }}/javascript:void(0)"
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/" id="get-url" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/index2.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/index3.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/index4.html" aria-expanded="false">
                                <span>
                                    <i class="ti ti-cpu"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/index5.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/index6.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/app-kanban.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/app-notes.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/app-contact.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/app-contact2.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/app-invoice.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/page-user-profile.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow" href="{{ asset('themplete/back') }}/javascript:void(0)" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/eco-add-product.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/eco-edit-product.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/page-pricing.html" aria-expanded="false">
                                <span>
                                    <i class="ti ti-currency-dollar"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/page-faq.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/page-account-settings.html" aria-expanded="false">
                                <span>
                                    <i class="ti ti-user-circle"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../landingpage/index.html" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/widgets-feeds.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/widgets-apps.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/widgets-data.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/ui-cards.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/ui-card-customs.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/ui-card-weather.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/ui-card-draggable.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/component-sweetalert.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/component-nestable.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/component-noui-slider.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/component-rating.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/component-toastr.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-dropzone.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-mask.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-typeahead.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-bootstrap-validation.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-custom-validation.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-picker-colorpicker.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-picker-bootstrap-rangepicker.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-picker-bootstrap-datepicker.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-picker-material-datepicker.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/form-editor-tinymce.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <!-- ---------------------------------- -->
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-basic.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-vertical.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-horizontal.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-actions.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-row-separator.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-bordered.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-detail.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-striped-row.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-floating-input.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <!-- ---------------------------------- -->
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-wizard.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <!-- ---------------------------------- -->
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/../main/form-repeater.html" aria-expanded="false">
                                <span class="d-flex">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-animation.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-search-result.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-gallery.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-treeview.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-block-ui.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item mb-3">
                                    <a href="{{ asset('themplete/back') }}/../main/pages-session-timeout.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <!-- ---------------------------------- -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ asset('themplete/back') }}/../main/icon-tabler.html" aria-expanded="false">
                        ...
                        <!-- ---------------------------------- -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ asset('themplete/back') }}/../main/icon-solar.html" aria-expanded="false">
                                <span class="rounded-3">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ asset('themplete/back') }}/../main/authentication-error.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-alert-circle"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-login.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-login2.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-register.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-register2.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-forgot-password.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-forgot-password2.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-two-steps.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/../main/authentication-two-steps2.html" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ asset('themplete/back') }}/../main/authentication-maintenance.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ asset('themplete/back') }}/../docs/index.html" aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-file-text"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ asset('themplete/back') }}/javascript:void(0)" class="sidebar-link">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="ti ti-circle"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    ...
                                    <ul aria-expanded="false" class="collapse two-level">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link has-arrow" href="{{ asset('themplete/back') }}/javascript:void(0)"
                                                aria-expanded="false">
                                                <div class="round-16 d-flex align-items-center justify-content-center">
                                                    <i class="ti ti-circle"></i>
                                                </div>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link link-disabled" href="{{ asset('themplete/back') }}/#disabled" aria-expanded="false">
                                <span class="d-flex">
                                    <i class="ti ti-ban"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ asset('themplete/back') }}/#sub" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between" href="{{ asset('themplete/back') }}/#chip" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between" href="{{ asset('themplete/back') }}/#outlined" aria-expanded="false">
                                <div class="d-flex align-items-center gap-3">
                                    <span class="d-flex">
                                        <i class="ti ti-mood-smile"></i>
                                    </span>
        ...
        <div class="page-wrapper">
                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        <ul class="navbar-nav">
                            <li class="nav-item nav-icon-hover-bg rounded-circle ms-n2">
                                <a class="nav-link sidebartoggler" id="headerCollapse" href="{{ asset('themplete/back') }}/javascript:void(0)">
                                    <i class="ti ti-menu-2"></i>
                                </a>
                            </li>
                            <li class="nav-item nav-icon-hover-bg rounded-circle d-none d-lg-flex">
                                <a class="nav-link" href="{{ asset('themplete/back') }}/javascript:void(0)" data-bs-toggle="modal"
                        ...
                        <ul class="navbar-nav quick-links d-none d-lg-flex align-items-center">
                            ...
                            <li class="nav-item nav-icon-hover-bg rounded w-auto dropdown d-none d-lg-block mx-0">
                                <div class="hover-dd">
                                    <a class="nav-link" href="{{ asset('themplete/back') }}/javascript:void(0)">
                                                    ...
                                                    <div class="row align-items-center py-3">
                                                        <div class="col-8">
                                                            <a class="fw-semibold d-flex align-items-center lh-1"
                                                                href="{{ asset('themplete/back') }}/javascript:void(0)">
                        ...
                        <a class="navbar-toggler nav-icon-hover-bg rounded-circle p-0 mx-0 border-0"
                            href="{{ asset('themplete/back') }}/javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                                    ...
                                    <li class="nav-item nav-icon-hover-bg rounded-circle">
                                        <a class="nav-link moon dark-layout" href="{{ asset('themplete/back') }}/javascript:void(0)">
                                            <i class="ti ti-moon moon"></i>
                                        </a>
                                        <a class="nav-link sun light-layout" href="{{ asset('themplete/back') }}/javascript:void(0)">
                                            <i class="ti ti-sun sun"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                                        <a class="nav-link" href="{{ asset('themplete/back') }}/javascript:void(0)" id="drop2" aria-expanded="false">
                                    ...
                                    <!-- ------------------------------- -->
                                    <li class="nav-item nav-icon-hover-bg rounded-circle">
                                        <a class="nav-link position-relative" href="{{ asset('themplete/back') }}/javascript:void(0)"
                                    ...
                                    <!-- ------------------------------- -->
                                    <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                                        <a class="nav-link position-relative" href="{{ asset('themplete/back') }}/javascript:void(0)" id="drop2"
                                            aria-expanded="false">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link pe-0" href="{{ asset('themplete/back') }}/javascript:void(0)" id="drop1"
                                            aria-expanded="false">
                    ...
                    <nav class="navbar navbar-expand-xl container-fluid p-0">
                        <ul class="navbar-nav align-items-center">
                            <li class="nav-item nav-icon-hover-bg rounded-circle d-flex d-xl-none ms-n2">
                                <a class="nav-link sidebartoggler" id="sidebarCollapse" href="{{ asset('themplete/back') }}/javascript:void(0)">
                                    <i class="ti ti-menu-2"></i>
                                </a>
                            </li>
                ...
                <div>
                    ...
                    <nav id="sidebarnavh" class="sidebar-nav scroll-sidebar container-fluid">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link two-column has-arrow" href="{{ asset('themplete/back') }}/javascript:void(0)"
                                    aria-expanded="false">
                                    <span>
                                        <i class="ti ti-archive"></i>
                                    </span>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('themplete/back') }}/javascript:void(0)" class="sidebar-link has-arrow">
                                            <i class="ti ti-circle"></i>
                    ...
                    <div class="owl-carousel counter-carousel owl-theme">
                            ...
                            <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-user-male.svg" width="50" height="50"
                        ...
                        <div class="item">
                            <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-briefcase.svg" width="50" height="50"
                                            class="mb-3" alt="modernize-img" />
                        ...
                        <div class="item">
                            <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-mailbox.svg" width="50" height="50"
                                            class="mb-3" alt="modernize-img" />
                        ...
                        <div class="item">
                            <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-favorites.svg" width="50" height="50"
                                            class="mb-3" alt="modernize-img" />
                        ...
                        <div class="item">
                            <div class="card border-0 zoom-in bg-success-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-speech-bubble.svg" width="50" height="50"
                                            class="mb-3" alt="modernize-img" />
                        ...
                        <div class="item">
                            <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/svgs/icon-connect.svg" width="50" height="50"
                                            class="mb-3" alt="modernize-img" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <ul class="hstack mb-0">
                                            <li class="ms-n8">
                                                <a href="{{ asset('themplete/back') }}/javascript:void(0)" class="me-1">
                                                    <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-2.jpg"
                            ...
                            <div class="card text-bg-primary border-0 w-100">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-center mt-3">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/backgrounds/piggy.png" class="img-fluid"
                                            alt="modernize-img" />
                                    </div>
                                </div>
                                            ...
                                            <tbody class="border-top">
                                                ...
                                                <tr>
                                                    <td class="border-0 ps-0">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 pe-1">
                                                                <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-8.jpg"
                                                                    class="rounded-circle" width="40" height="40"
                                                                    alt="modernize-img" />
                                                            </div>
                                                            <div>
            ...
            <div class="offcanvas customizer offcanvas-end" tabindex="-1" id="offcanvasExample"
                ...
                <div class="offcanvas-body h-n80" data-simplebar>
                    ...
                    <div class="d-flex flex-row gap-3 customizer-box" role="group">
                        <a href="{{ asset('themplete/back') }}/javascript:void(0)" class="fullsidebar">
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content rounded-1">
                    <div class="modal-header border-bottom">
                        ...
                        <a href="{{ asset('themplete/back') }}/javascript:void(0)" data-bs-dismiss="modal" class="lh-1">
        ...
        <div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight"
            ...
            <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
                ...
                <div class="align-bottom">
                    ...
                    <a href="{{ asset('themplete/back') }}/../main/eco-checkout.html" class="btn btn-outline-primary w-100">Go to shopping cart</a>
                </div>
            </div>
        </div>
    </div>
