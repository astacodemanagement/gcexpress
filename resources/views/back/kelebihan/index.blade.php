                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="file_export"
                                        ...
                                        <tbody>
                                            @foreach ($kelebihan as $p)
                                                <!-- start row -->
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>{{ $p->nama_kelebihan }}</td>
                                                    <td>{{ \Illuminate\Support\Str::limit($p->deskripsi, 20) }}</td>

                                                    <td>
                                                        <a href="/upload/kelebihan/{{ $p->gambar }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/kelebihan/{{ $p->gambar }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_kelebihan" class="form-label fw-semibold">Nama Kelebihan</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_kelebihan" name="nama_kelebihan"
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_kelebihan_edit" class="form-label fw-semibold">Nama Kelebihan</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_kelebihan_edit" name="nama_kelebihan"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
