                                        ...
                                        <tbody>
                                            @foreach ($users as $p)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $p->email }}</td>
                                                    <td>
                                                        <a href="/upload/user/{{ $p->profile_image }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/user/{{ $p->profile_image }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label for="name" class="form-label fw-semibold">Nama User</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Ex : Jaya Saputra" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label for="phone_number" class="form-label fw-semibold">No Telp</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="number" class="form-control" id="phone_number" name="phone_number"
                                                placeholder="0850000000" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email"
                                                placeholder="maxima@gmail.com" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <label for="profile_image" class="form-label fw-semibold">Gambar</label>
                                            <input type="file" class="form-control" id="profile_image"
                                                name="profile_image" onchange="previewImage()">
                                                ...
                                                function previewImage() {
                                                    ...
                                                    reader.onload = function(e) {
                                                        ...
                                                        img.onload = function() {
                                                            ...
                                                            var maxWidth = 150; // Max width untuk pratinja profile_image
                                    ...
                                    <div class="col-6">
                                        <div class="mb-4">
                                            <label for="password_confirmation"
                                                class="form-label fw-semibold">Konf.Password</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label for="phone_number" class="form-label fw-semibold">No Telp</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="number" class="form-control" id="phone_number_edit"
                                                name="phone_number" placeholder="0850000000" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <label for="profile_image" class="form-label fw-semibold">Gambar</label>
                                            <input type="file" class="form-control" id="profile_image_edit"
                                                name="profile_image" onchange="previewImage2()">
                                            ...
                                            <script>
                                                function previewImage2() {
                                                    ...
                                                    var fileInput = document.getElementById('profile_image_edit');
                                                    var file = fileInput.files[0];
                                                    var reader = new FileReader();
                                    ...
                                    <script>
                                        document.getElementById('password_confirmation_edit').addEventListener('keyup', function() {
...
@push('scripts')
    ...
    {{--
      ...
      <script src="{{ asset('themplete/back') }}/dist/js/app.min.js"></script>
      <script src="{{ asset('themplete/back') }}/dist/js/app.init.js"></script>
      <script src="{{ asset('themplete/back') }}/dist/js/app-style-switcher.js"></script>
      <script src="{{ asset('themplete/back') }}/dist/js/sidebarmenu.js"></script> --}}
