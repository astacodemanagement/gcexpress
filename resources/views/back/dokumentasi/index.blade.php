                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_dokumentasi_edit" class="form-label fw-semibold">Nama Dokumentasi</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_dokumentasi_edit" name="nama_dokumentasi"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
...
@push('scripts')
    ...
    <script>
        ...
        $('#deskripsi_edit').summernote({
            ...
            callbacks: {
                onInit: function() {
                    $('#deskripsi_edit').summernote('code', data
                        .deskripsi); // Pastikan 'deskripsi' adalah field yang benar
                }
            }
        });
    </script>
