                                        ...
                                        <tbody>
                                            @foreach ($layanan as $p)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/upload/layanan/{{ $p->gambar }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/layanan/{{ $p->gambar }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_layanan_edit" class="form-label fw-semibold">Nama Layanan</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
