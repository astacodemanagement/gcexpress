                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control" name="tanya" id="tanya" cols="30" rows="2"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-4">
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_faq_edit" class="form-label fw-semibold">Nama FAQ</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_faq_edit" name="nama_faq"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <label for="tanya_edit" class="form-label fw-semibold">Tanya</label>
                                            <textarea class="form-control" id="tanya_edit" name="tanya"  cols="30" rows="2"></textarea>
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="mb-4">
                                            <label for="jawab_edit" class="form-label fw-semibold">Jawab</label>
                                            <textarea class="form-control" id="jawab_edit" name="jawab"  cols="30" rows="2"></textarea>
                                        </div>
                                    </div>
