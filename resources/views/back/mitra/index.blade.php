                                        ...
                                        <tbody>
                                            @foreach ($mitra as $p)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/upload/mitra/{{ $p->gambar }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/mitra/{{ $p->gambar }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_mitra_edit" class="form-label fw-semibold">Nama Mitra</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_mitra_edit" name="nama_mitra"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
