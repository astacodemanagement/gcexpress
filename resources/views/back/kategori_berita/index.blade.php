                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_kategori_berita" class="form-label fw-semibold">Nama Kategori Berita</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_kategori_berita" name="nama_kategori_berita"
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_kategori_berita_edit" class="form-label fw-semibold">Nama Kategori Berita</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_kategori_berita_edit" name="nama_kategori_berita"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
