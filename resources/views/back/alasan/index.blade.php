                                        ...
                                        <tbody>
                                            @foreach ($alasan as $p)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/upload/alasan/{{ $p->gambar }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/alasan/{{ $p->gambar }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_alasan" class="form-label fw-semibold">Nama Alasan</label>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_alasan_edit" class="form-label fw-semibold">Nama Alasan</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
