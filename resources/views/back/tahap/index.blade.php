                                        ...
                                        <tbody>
                                            @foreach ($tahap as $p)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/upload/tahap/{{ $p->gambar }}" target="_blank">
                                                            <img style="max-width:50px; max-height:50px"
                                                                src="/upload/tahap/{{ $p->gambar }}" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_tahap" class="form-label fw-semibold">Nama Tahap</label>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="nama_tahap_edit" class="form-label fw-semibold">Nama Tahap</label>
                                            <span class="text-danger">*</span> <!-- Menambahkan span untuk keterangan -->
                                            <input type="text" class="form-control" id="nama_tahap_edit" name="nama_tahap"
                                                placeholder="Ex : Nama" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
            ...
            $('#file_export').on('click', '.btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#nama_tahap_edit').val(data.nama_tahap);
