...
@section('content')
                        ...
                        {{-- <div class="about-one__content-features">
                            <ul>
                                <li class="wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="inner">
                                        <div class="icon-box">
                                            <img src="{{ asset('themplete/front') }}/assets/img/icon/about/worldwide-delivery.png"
                                                alt="#">
                                        </div>
                                        <div class="text-box">
                                ...
                                <li class="wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    <div class="inner">
                                        <div class="icon-box">
                                            <img src="{{ asset('themplete/front') }}/assets/img/icon/about/secure-delivery.png"
                                                alt="#">
                                        </div>
                                        <div class="text-box">
        ...
        <div class="container">
            <div class="service-one__top">
                <div class="sec-title">
                    ...
                    <h2>Layanan logistik yang <br> cepat dan profesional</h2>
                </div>
    ...
    <section class="testimonials-two" style="margin-top: -300px;">
        
        <!--Start Brand One-->
        <div class="brand-one">
            <div class="sec-title text-center">
                <h2>Mitra {{ $profil->nama_perusahaan }}</h2>
            </div>
            <div class="shape1 float-bob-x"><img src="{{ asset('themplete/front') }}/assets/img/shape/brand-v1-shape1.png"
                    alt=""></div>
    ...
    <section class="choose-us-one">
        <div class="container">
            <div class="sec-title text-center">
                ...
                <h2>Beberapa alasan untuk memilih kami</h2>
            </div>
            <div class="row">
                @foreach ($alasan as $p)
        ...
        <div class="container">
            <div class="blog-one__top">
                <div class="sec-title">
                    ...
                    <h2>Postingan Terakhir Berita</h2>
                </div>
                <div class="btn-box">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-one__single">
                                ...
                                <div class="blog-one__single-content">
                                    <h2><a href="{{ asset('themplete/front') }}/blog-details.html">{{ $p->judul_berita }}</a></h2>
                                    <ul class="meta-box">
                                        <li><a href="{{ asset('themplete/front') }}/#">By : {{ $p->penulis }}</a></li>
                                        <br>
                                        <li>{{ \Carbon\Carbon::parse($p->tanggal_posting)->translatedFormat('l, d F Y') }}</li>
