...
class ProfilController extends Controller
{
    public function index()
    {
        ...
        // Mengambil satu data profil
        $profil = Cache::remember('profil', 1, function () {
            return Profil::first(); // Mengambil satu data pertama dari tabel profil
        });

        return view('back.profil.index', compact('title', 'subtitle', 'profil'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            $request->validate([
                ...
                'nama_perusahaan.required' => 'Nama profil wajib diisi.',
                ...
                'nama_perusahaan.unique' => 'Nama profil sudah ada.',
